...
class fee {
   validateFeeCalculate = (data) => {
    const schema = Joi.object({
        ...
        increasingRateWhenBelongToRemoteArea: Joi.number().required(),
        optionService: Joi.string().required(),
        isBelongToRemoteArea: Joi.boolean().required()
    }).strict();
