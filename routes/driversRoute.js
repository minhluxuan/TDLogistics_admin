...
router.get("/get_objects", auth.isAuthenticated(), auth.isAuthorized(["ADMIN", "MANAGER", "HUMAN_RESOURCE_MANAGER", "PARTNER_DRIVER"]), auth.isActive(), driversController.getObjectsCanHandleTask);
