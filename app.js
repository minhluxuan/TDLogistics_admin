...
const driversRouter = require("./routes/driversRoute");
...
const allowedOrigins = [
    "https://admin.tdlogistics.net.vn",
    "https://app.tdlogistics.net.vn",
    "https://delivery.tdlogistics.net.vn",
    "http://localhost:5000",
    "http://localhost:3000",
    "http://localhost:3001",
    "http://localhost:3002",
    "http://localhost:3003",
    "http://localhost:3004",
    "https://customer-merchant-web.vercel.app",
    "https://testwebmerchant.vercel.app",
    "https://admin-td-logistics-web.vercel.app",
];
